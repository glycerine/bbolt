...
import (
	...
	berrors "github.com/glycerine/bbolt/errors"
...
func TestDBUnmap(t *testing.T) {
	...
	// Error: copylocks: call of reflect.ValueOf copies lock value: github.com/glycerine/bbolt.DB contains sync.Once contains sync.Mutex (govet)
	//nolint:govet
